...
- **DO** run `bash <skill-directory>/scripts/install-skill.sh <skill-directory>` in the final installed directory when shell execution is available. If this did not happen, treat the installation as incomplete.
